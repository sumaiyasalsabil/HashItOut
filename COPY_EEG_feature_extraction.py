...
"""
def generate_feature_vectors_from_samples(file_path, nsamples, period, file_no,
										  state = None, 
	...
	if ret is not None:
		file_no_column = np.full((ret.shape[0], 1), file_no)
		ret = np.hstack([ret, file_no_column])
		feat_names.append('file_no')
